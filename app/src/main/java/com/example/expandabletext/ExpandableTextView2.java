...
public class ExpandableTextView2 extends androidx.appcompat.widget.AppCompatTextView {
    ...
    private String  mToShrinkHint;//"关闭"
    ...
    private CharSequence getNewTextByConfig() {
        ...
        switch (mCurrState) {
            case STATE_SHRINK: {
                ...
                //去除 ".." "展开"占用 后的索引
                int indexEndTrimmed = indexEnd - getLengthOfString(mEllipsisHint) - (mShowToExpandHint ? getLengthOfString(mToExpandHint) + getLengthOfString(mGapToExpandHint) : 0);
                ...
                //计算最后一行 "展开" + ".." 的宽度
                float widthTailReplaced = mTextPaint.measureText(getContentOfString(mEllipsisHint) + (mShowToExpandHint ? (getContentOfString(mToExpandHint) + getContentOfString(mGapToExpandHint)) : ""));
